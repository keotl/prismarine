...
mkdir -p build/prismarine/debian build/prismarine/usr/lib/prismarine-server/static build/prismarine/etc/nginx/sites-available build/prismarine/etc/systemd/user
...
cp deploy/config/prismarine.service build/prismarine/etc/systemd/user/
